...
# Page Config
######################
st.set_page_config(page_title="RVTools Analyse", page_icon='./style/es-favicon.png', layout="wide")
...
######################
with header_section:
    st.markdown("<h1 style='text-align: left; color:#000000;'>RVTools Analyse - by Erik Sterck</h1>", unsafe_allow_html=True)
    st.markdown('Ein Hobby-Projekt von [**Martin Stenke**](https://www.linkedin.com/in/mstenke/) zur einfachen Analyse einer [**RVTools**](https://www.robware.net/rvtools/) Auswertung. Bei Fragen kommen Sie auf das Systemhaus [**Erik Sterck GmbH**](https://www.eriksterck.de/) zu. (Zuletzt aktualisiert: 24.08.2022)')
...
if uploaded_file is not None and uploaded_file_valid is True and len(vCluster_selected) != 0:
    ...
    with analysis_section: 
        ...
        with vCluster_expander:
            ...
            with column_storage:
                st.markdown("<h4 style='text-align: center; color:#000000;'>vDatastore:</h4>", unsafe_allow_html=True)
        ...
        with vHosts_expander:
            ...
            with column_hardware:
                st.markdown("<h5 style='text-align: center; color:#000000;'>pHost Details:</h5>", unsafe_allow_html=True)
        ...
        with guest_os_expander:
            ...
            with column_guestos_1:
                st.markdown(f"<h5 style='text-align: center; color:#000000;'>Gastbetriebssysteme nach Configurations-File:</h5>", unsafe_allow_html=True)
            ...
            with column_guestos_2:
                st.markdown(f"<h5 style='text-align: center; color:#000000;'>Gastbetriebssysteme nach VMware Tools:</h5>", unsafe_allow_html=True)        
        ...
        with vCPU_expander:            
            ...
            with column_vCPU_1:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vCPU Auswertung</u></h5>", unsafe_allow_html=True)
            ...
            with column_vCPU_2:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vCPU-Verteilung</u></h5>", unsafe_allow_html=True)
        ...
        with vRAM_expander:
            ...
            with column_vRAM_table:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vMemory Auswertung</u></h5>", unsafe_allow_html=True)
            ...
            with column_vRAM_plot:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vMemory-Verteilung</u></h5>", unsafe_allow_html=True)
        ...
        with vStorage_expander:
            ...
            with column_vDatastore:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vDatastore Auswertung</u></h5>", unsafe_allow_html=True)
            ...
            with column_vInfo:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vInfo Storage Auswertung</u></h5>", unsafe_allow_html=True)
                st.table(vInfo_df)
            ...
            with column_vDisk_plot:
                st.markdown("<h5 style='text-align: left; color:#000000; '><u>vDisk Verteilung</u></h5>", unsafe_allow_html=True)
            ...
            with column_vm_storage_chart:
                st.markdown("<h5 style='text-align: center; color:#000000; '>VM Capacity - Total:</h5>", unsafe_allow_html=True)
